...
banner:
  content: We recommend using <strong>Cloudflare Workers</strong> for new projects. For existing Pages projects, see our <a href="/workers/static-assets/migrate-from-pages/">migration guide</a> and <a href="https://ricepuritytest.blog/</a>.
  type: note
  dismissible:
